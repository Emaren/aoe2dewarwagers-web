...
export const podiumTitles: ChampionTitleDefinition[] = [
  {
    ...
    slug: "world",
    type: "world",
    displayName: "AoE2DE War Wagers World Champion",
    ...
    detailLore: "The World Champion is the main AoE2DE War Wagers crown: public, hunted, and defended under replay proof.",
